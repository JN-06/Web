...
<section>
<h1 class = "noncoffee"> Non-Coffee </h1>
<div class = "line1_product">
	...
	<div id = "Chocolate" class = "product">
		<div class = "popup_product">
			<img src = "Chocolate.jpg" alt = "Chocolate" width = "150" height = "150"> 
	...
	<div class = "image_product">
		<a href = "#Mint_Chocolate"> 
		<figure> 
		<img src = "Mint_Chocolate.jpg" alt = "Mint Chocolate"> 
		</figure> 
		Mint Chocolate </a>
	</div>

	<div id = "Mint_Chocolate" class = "product">
		<div class = "popup_product">
			<img src = "Mint_Chocolate.jpg" alt = "Mint Chocolate" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Mint Chocolate </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
			</div>
			<a href = "#" class = "close"> &times; </a>
	...
	<div class = "image_product">
		<a href = "#Yuzu_Soda"> 
		<figure> 
		<img src = "Yuzu_Soda.jpg" alt = "Yuzu Soda"> 
		</figure> 
		Yuzu Soda </a>
	</div>

	<div id = "Yuzu_Soda" class = "product">
		<div class = "popup_product">
			<img src = "Yuzu_Soda.jpg" alt = "Yuzu Soda" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Yuzu Soda </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
...
<div class = "line2_product">
	<div class = "image_product">
		<a href = "#Orange_Chocolate"> 
		<figure> 
		<img src = "Orange_Chocolate.jpeg" alt = "Orange Chocolate"> 
		</figure> 
		Orange <br> <span> Chocolate </span> </a>
	</div>

	<div id = "Orange_Chocolate" class = "product">
		<div class = "popup_product">
			<img src = "Orange_Chocolate.jpeg" alt = "Orange Chocolate" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Orange Chocolate </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
			</div>
			<a href = "#" class = "close"> &times; </a>
	...
	<div class = "image_product">
		<a href = "#Strawberry_Matcha"> 
		<figure> 
		<img src = "Strawberry_Matcha.jpg" alt = "Strawberry Matcha"> 
		</figure> 
		Strawberry <br><span> Matcha </span> </a>
	</div>

	<div id = "Strawberry_Matcha" class = "product">
		<div class = "popup_product">
			<img src = "Strawberry_Matcha.jpg" alt = "Strawberry Matcha" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Strawberry Matcha </h1>
				<h2> MP: RM14.90 </h2>
				<h2> NP: RM16.90 </h2>
			</div>
			<a href = "#" class = "close"> &times; </a>
	...
	<div class = "image_product">
		<a href = "#Strawberry_Soda"> 
		<figure> 
		<img src = "Strawberry_Soda.jpg" alt = "Strawberry Soda"> 
		</figure> 
		Strawberry <br> <span> Soda </span> </a>
	</div>

	<div id = "Strawberry_Soda" class = "product">
		<div class = "popup_product">
			<img src = "Strawberry_Soda.jpg" alt = "Strawberry Soda" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Strawberry Soda </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
			</div>
			<a href = "#" class = "close"> &times; </a>
...
<div class = "line3_product">	
	...
	<div class = "image_product">
		<a href = "#Yuzu_Cheese"> 
		<figure> 
		<img src = "Yuzu_Cheese.jpg" alt = "Yuzu Cheese"> 
		</figure> 
		Yuzu Cheese </a>
	</div>

	<div id = "Yuzu_Cheese" class = "product">
		<div class = "popup_product">
			<img src = "Yuzu_Cheese.jpg" alt = "Yuzu Cheese" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Yuzu Cheese </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
	...
	<div class = "image_product">
		<a href = "#Yuri_Matcha"> 
		<figure> 
		<img src = "Yuri_Matcha.jpg" alt = "Yuri Matcha"> 
		</figure> 
		Yuri Matcha</a>
	</div>

	<div id = "Yuri_Matcha" class = "product">
		<div class = "popup_product">
			<img src = "Yuri_Matcha.jpg" alt = "Yuri Matcha" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Yuri Matcha </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
	...
	<div class = "image_product">
		<a href = "#Yuzu_Matcha"> 
		<figure> 
		<img src = "Yuzu_Matcha.jpg" alt = "Yuzu Matcha"> 
		</figure> 
		Yuzu Matcha </a>
	</div>

	<div id = "Yuzu_Matcha" class = "product">
		<div class = "popup_product">
			<img src = "Yuzu_Matcha.jpg" alt = "Yuzu Matcha" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Yuzu Matcha </h1>
				<h2> MP: RM14.90 </h2>
				<h2> NP: RM16.90 </h2>
...
<div class = "line4_product">
	...
	<div class = "image_product">
		<a href = "#Houjicha"> 
		<figure> 
		<img src = "Houjicha.jpg" alt = "Houjicha"> 
		</figure> 
		Houjicha </a>
	</div>

	<div id = "Houjicha" class = "product">
		<div class = "popup_product">
			<img src = "Houjicha.jpg" alt = "Houjicha" width = "150" height = "150"> 
			<div class = "text_product">
				<h1> Houjicha </h1>
				<h2> MP: RM13.90 </h2>
				<h2> NP: RM15.90 </h2>
